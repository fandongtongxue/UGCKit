...
{
    [HUDHelper alert:msg cancel:LocalString(@"Common.OK")];
}
+ (void)alert:(NSString *)msg action:(void(^)(void))action
{
    [HUDHelper alert:msg cancel:LocalString(@"Common.OK") action:action];
}
+ (void)alert:(NSString *)msg cancel:(NSString *)cancel
{
    [HUDHelper alertTitle:LocalString(@"Common.Hint") message:msg cancel:cancel];
}
+ (void)alert:(NSString *)msg cancel:(NSString *)cancel action:(void(^)(void))action
{
    [HUDHelper alertTitle:LocalString(@"Common.Hint") message:msg cancel:cancel action:action];
}
